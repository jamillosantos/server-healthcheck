...
// Source: github.com/jamillosantos/services-healthcheck (interfaces: Checker)

// Package svchealthcheck is a generated GoMock package.
...
func (m *MockChecker) Check(arg0 context.Context) error {
	m.ctrl.T.Helper()
